<div class="bg-background w-screen min-h-screen">
	<div class="bg-background max-w-7xl mx-auto px-4 py-6">
		<h1 id="isi" class="text-3xl text-center font-bold mb-4">komunitasku</h1>

		<div class="grid grid-cols-1 gap-6 mb-6">
			<form class="bg-white p-4 rounded-md shadow-md">
				<h2 class="font-bold text-2xl" id="isi">Informasi</h2>
				<textarea
					class="w-full mt-2 p-2 border bg-field rounded-md w-full focus:outline-none focus:ring-2 focus:ring-base"
					rows="2"
				></textarea>
				<h2 class="font-bold text-2xl mt-2" id="isi">Jadwal Latihan</h2>
				<textarea
					class="w-full mt-2 p-2 border bg-field rounded-md w-full focus:outline-none focus:ring-2 focus:ring-base"
					rows="2"
				></textarea>
				<h2 class="font-bold text-2xl mt-2" id="isi">Manfaat</h2>
				<textarea
					class="w-full mt-2 p-2 border bg-field rounded-md w-full focus:outline-none focus:ring-2 focus:ring-base"
					rows="2"
				></textarea>
				<h2 class="font-bold text-2xl mt-2" id="isi">Syarat dan Ketentuan</h2>
				<textarea
					class="w-full mt-2 p-2 border bg-field rounded-md w-full focus:outline-none focus:ring-2 focus:ring-base"
					rows="2"
				></textarea>
				...
				<div class="mt-2 flex justify-center items-center">
					<button class="w-4 mr-4 transform hover:text-blue-500 hover:scale-110">
						<svg
