...
<div class="flex items-center justify-center mt-20">
    <div class="flex w-2/4 items-center">
        <div class="flex flex-col space-y-4">
            ...
            <button id="create" type="submit" class="bg-base text-2xl font-semibold px-3 py-1.5 rounded-lg flex items-center hover:bg-slate-300 hover:border-[1px] hover:border-black ease-in duration-400">
                <svg class="w-15 h-15 mr-0.5 mt-1" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="1 1 25 25">
        ...
        <div class="w-3/4 pl-10">
            <div class="flex flex-wrap items-center justify-center gap-4 mt-20">
                <div class="max-w-xs bg-white shadow-lg rounded-lg overflow-hidden border border-black">
                  ...
                  <div class="p-4">
                    <h4 class="text-gray-700 font-bold">Bakso 10K</h4>
                    <p class="text-yellow-500 font-semibold">100 point</p>
                  </div>
                </div>
        
                <div class="max-w-xs bg-white shadow-lg rounded-lg overflow-hidden border border-black">
                  <!-- <img class="w-full h-32 object-cover" src="path_to_image/esteh.jpg" alt="Es Teh"> -->
                  <div class="p-4">
                    <h4 class="text-gray-700 font-bold">Es Teh</h4>
                    <p class="text-yellow-500 font-semibold">10 point</p>
                  </div>
                </div>
        
                <div class="max-w-xs bg-white shadow-lg rounded-lg overflow-hidden border border-black">
                  <!-- <img class="w-full h-32 object-cover" src="path_to_image/e-toll.jpg" alt="E-toll 50K"> -->
                  <div class="p-4">
                    <h4 class="text-gray-700 font-bold">E-toll 50K</h4>
                    <p class="text-yellow-500 font-semibold">150 point</p>
                  </div>
                </div>
            </div>
        </div>
