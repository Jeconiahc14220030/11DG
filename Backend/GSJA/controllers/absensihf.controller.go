...
func POSTAbsensiHf(absensiHf models.AbsensiHf) (models.Response, error) {
	...
	sqlStatement := "INSERT INTO absensi_hf (id_anggota, id_hf, tanggal, topik) VALUES (?, ?, ?, ?)"
	_, err := con.Exec(sqlStatement, absensiHf.IdAnggota, absensiHf.Idhf, absensiHf.Tanggal, absensiHf.Topik)
